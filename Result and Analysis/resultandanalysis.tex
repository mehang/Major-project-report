...
\begin{figure}[h!]
        \centering
        \includegraphics[width=140mm]{resources/mehang/6.5/SVM_Kernel}
        \caption{SVM Kernel}
\end{figure}
...
\begin{figure}[h!]
        \centering
        \includegraphics[width=150mm]{resources/mehang/6.5/ANN_HiddenNodes}
...
\begin{figure}[h!]
        \centering
        \includegraphics[width=150mm]{resources/mehang/6.5/ANN_Iterations}
...
\begin{figure}[h!]
        \centering
        \includegraphics[width=150mm]{resources/mehang/6.5/ANN_Learning}
