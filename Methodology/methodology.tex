...
\begin{figure}[h!]
        \centering
        \includegraphics[width=100mm]{resources/mehang/4.5.2/MFCC_mean_Classical}
        \caption{Mean of MFCC of classical}
\end{figure}
\begin{figure}[h!]
        \centering
        \includegraphics[width=100mm]{resources/mehang/4.5.2/MFCC_mean_Hiphop}
        \caption{Mean of MFCC of hiphop}
\end{figure}
\begin{figure}[h!]
        \centering
        \includegraphics[width=100mm]{resources/mehang/4.5.2/MFCC_sd_Classical}
        \caption{Standard deviation of MFCC of classical}
\end{figure}
\begin{figure}[h!]
        \centering
        \includegraphics[width=100mm]{resources/mehang/4.5.2/MFCC_sd_Hiphop}
